...
// (e/*module*/, t/*exports*/, n/*__require*/) =>
{
  ...
  ;(Object.defineProperty(t, "__esModule", { value: !0 }),
    (t.GamePlaySystem = t.GamePlayEvent = void 0))
  var i = n(70655),
    r = n(86178),
    o = n(44656),
    a = n(26511),
    ...
    return (
      ...
      (t.prototype.update = function (e) {
        ...
        ;(this.entities.forEach(function (e) {
          ...
          ;(d._fullAmount.set(e.owner, n), d._isAnyBuilding.set(e.owner, !0))
        }),
          h || this.isAnyBotAlive() || ((h = !0), (f = !0)),
          h || this.isAlive(u.PlayerType.First) || ((h = !0), (f = !1)))
        var v = [],
          y = 0
        ;(this._fullAmount.forEach(function (e, t) {
          void 0 !== e && (v.push({ owner: t, count: e }), (y += e))
        }),
          ...
          h &&
            ...
            null === (a = (0, o.lazyGet)(c.TypesGame.model)) || void 0 === a || a.endStage(f)))
      }),
      ...
      (t.prototype.isAnyBotAlive = function () {
        ...
        try {
          for (var n = i.__values(this._players), r = n.next(); !r.done; r = n.next()) {
            var o = r.value
            if (o !== u.PlayerType.Neutral && o !== u.PlayerType.First && this.isAlive(o)) return !0
          }
        } catch (t) {
          e = { error: t }
        } finally {
