...
// (e/*module*/, t/*exports*/, n/*__require*/) =>
{
              ...
              i.process_params = function (e, t, n, i, a) {
                ...
                if ((0, s.$A)(n.originalUrl || "") + p === (0, s.$A)(n._reconstructedRoute)) {
                  ...
                  if (e && "custom" !== e.metadata.source) {
                    ...
                    e.setName(...u(n, { path: !0, method: !0, customRoute: t }))
                  }
                }
    ...
    setupOnce(e, t) {
      ...
      ;(0, f.hl)(i.prototype, "query", function (e) {
        return function (n, i, r) {
          ...
          const c = void 0 !== i ? e.call(this, n, i) : e.call(this, n)
          return (0, l.J8)(c)
            ? c.then(
  ...
  const B = (e, t, n) => {
      ...
      return (o) => {
        t.value >= 0 &&
          (o || n) &&
          ((r = t.value - (i || 0)), (r || void 0 === i) && ((i = t.value), (t.delta = r), e(t)))
      }
    },
    F = () =>
    ...
    e &&
      ...
      ((e) => {
        ...
        if (o) {
          i = B(e, n)
          const t = () => {
            z[n.id] || (r(o.takeRecords()), o.disconnect(), (z[n.id] = !0), i(!0))
          }
      ...
      ((e) => {
        ...
        const r = (e) => {
            e.startTime < t.firstHiddenTime &&
              ((n.value = e.processingStart - e.startTime), n.entries.push(e), i(!0))
          },
          o = (e) => {
            e.forEach(r)
          },
  ...
  var ne = n(9732),
    ie = n(57321)
  const re = ["localhost", /^\//],
    oe = { traceFetch: !0, traceXHR: !0, tracingOrigins: re, tracePropagationTargets: re }
  function ae(e) {
    const {
        traceFetch: t,
        traceXHR: n,
                ...
                if (a) {
                  ...
                  }
                  {
                    ...
                    return (
                      ...
                      r && t.push(r),
                      { ...a, "sentry-trace": o, baggage: t.length > 0 ? t.join(",") : void 0 }
                    )
                  }
                }
  ...
  class le {
    ...
    _createRouteTransaction(e) {
      ...
      const g = this._getCurrentHub(),
        { location: m } = k,
        v = (0, r.lb)(g, _, n, i, !0, { location: m }, o)
      return (
