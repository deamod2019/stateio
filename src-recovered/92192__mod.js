  ...
  ;((u.from = function (e) {
    ...
    (u.prototype.__matrix = function (e) {
      ...
      e.queue.length &&
        this.iterate(function (i, r, o, a) {
          ...
          switch (i[0]) {
            case "v":
              l = 0 === (u = e.calc(0, i[1], !0))[0] ? ["v", u[1]] : ["l", u[0], u[1]]
              break
            case "V":
              l =
                (u = e.calc(o, i[1], !1))[0] === e.calc(o, a, !1)[0]
                  ? ["V", u[1]]
                  : ["L", u[0], u[1]]
              break
            case "h":
              l = 0 === (u = e.calc(i[1], 0, !0))[1] ? ["h", u[0]] : ["l", u[0], u[1]]
              break
            case "H":
              l =
                (u = e.calc(i[1], a, !1))[1] === e.calc(o, a, !1)[1]
                  ? ["H", u[0]]
                  : ["L", u[0], u[1]]
              break
            case "a":
    ...
    (u.prototype.iterate = function (e, t) {
      ...
      for (r = [], n = 0; n < o.length; n++)
        if (void 0 !== a[n]) for (i = 0; i < a[n].length; i++) r.push(a[n][i])
        else r.push(o[n])
