...
// (e/*module*/, t/*exports*/, n/*__require*/) =>
{
  ...
  ;(Object.defineProperty(t, "__esModule", { value: !0 }),
    (t.CookieModel = t.CookieModelKey = void 0))
  var i,
    r = n(70655),
    o = n(44656),
    a = n(86178),
    ...
    return (
      ...
      Object.defineProperty(t.prototype, "selectedColorSet", {
        get: function () {
          ...
          return d.SelectableColorsDataSet.filter(function (t) {
            ...
            return r.__assign(r.__assign({}, e), { selected: !0, stored: !0 })
          })[0]
        },
        enumerable: !1,
        configurable: !0,
      ...
      Object.defineProperty(t.prototype, "availableColors", {
        get: function () {
          ...
          return d.SelectableColorsDataSet.map(function (t) {
            ...
            return r.__assign(r.__assign({}, t), { stored: !0, selected: n })
          })
        },
        enumerable: !1,
        configurable: !0,
      ...
      (t.prototype.getColorByPlayerType = function (e) {
        ...
        if (e === p.PlayerType.First)
          (null === (t = this.selectedColorSet) || void 0 === t ? void 0 : t.data) &&
            (i = this.selectedColorSet.data)
        else if (
          e === p.PlayerType.Second &&
          (null === (n = this.selectedColorSet) || void 0 === n ? void 0 : n.id)
        ) {
      ...
      (t.prototype.get = function (t) {
        ...
        ;(void 0 !== n && "undefined" !== n) || (n = this.getDefaultStore()[t])
        return n
      }),
