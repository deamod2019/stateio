...
{
  ;("use strict")
  ;(Object.defineProperty(t, "__esModule", { value: !0 }), (t.parseLevelSVG = void 0))
  var i = n(70655),
    r = n(84194),
    o = function (e) {
      for (
        var t = function (t) {
            if (t) {
              if (t.id.startsWith("Centre")) return !0
              if (t.id.startsWith("Ð¡entre"))
                return (e.id.startsWith("Ð¡entre") || console.warn(e.id, "starts with Ð¡entre"), !0)
            }
            return !1
          },
