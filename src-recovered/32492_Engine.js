    ...
    s = (function () {
      ...
      return (
        ...
        (e.prototype.removeSystem = function (e) {
          ...
          return (
            -1 === t || (this._systems.splice(t, 1), e.onRemovedFromEngine(), e.setEngine(void 0)),
            this
          )
        }),
        ...
        (e.prototype.removeAllEntities = function () {
          this.removeAllEntitiesInternal(!1)
        }),
        (e.prototype.clear = function () {
          ;(this.removeAllEntitiesInternal(!0), this.removeAllSystems(), this.removeAllQueries())
        }),
        ...
        (e.prototype.addSystem = function (e, t) {
          if ((void 0 === t && (t = 0), e.setPriority(t), 0 === this._systems.length))
            this._systems[0] = e
          else {
        ...
        (e.prototype.removeSubscription = function (e, t) {
          for (var n = this._subscriptions.length; --n >= 0; ) {
            if (
              ...
              (this._subscriptions.splice(n, 1), void 0 !== t)
            )
              return
          }
        }),
