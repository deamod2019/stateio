  ...
  async function m(e, { throttleEndTimeMillis: t, backoffCount: n }, i, r = f) {
    ...
    try {
      ...
      if (u)
        return (
          l.warn(
            `Timed out fetching this Firebase app's measurement ID from the server. Falling back to the measurement ID ${u} provided in the "measurementId" field in the local Firebase config. [${null == e ? void 0 : e.message}]`,
          ),
    ...
    try {
      ...
      if (
        !(function (e) {
          if (!(e instanceof o.ZR && e.customData)) return !1
        ...
        if ((r.deleteThrottleMetadata(s), u))
          return (
            l.warn(
              `Failed to fetch this Firebase app's measurement ID from the server. Falling back to the measurement ID ${u} provided in the "measurementId" field in the local Firebase config. [${null == c ? void 0 : c.message}]`,
            ),
            { appId: s, measurementId: u }
          )
        throw t
      ...
      const d =
          503 ===
          Number(
            null === (a = null == c ? void 0 : c.customData) || void 0 === a
              ? void 0
              : a.httpStatus,
          )
  ...
  async function x(e, t, n, i, r, a, s) {
    ...
    const h = (async function () {
        ...
        try {
          ...
          return (
            l.warn(
              p.create("indexeddb-unavailable", { errorInfo: null == e ? void 0 : e.toString() })
                .message,
            ),
            !1
          )
    ...
    ;((function (e) {
      ...
      (function (e, t) {
        ...
        ;((n.src = `${u}?l=${e}&id=${t}`), (n.async = !0), document.head.appendChild(n))
      })(a, f.measurementId),
      C && (r("consent", "default", C), b(void 0)),
      r("js", new Date()))
    const m = null !== (c = null == s ? void 0 : s.config) && void 0 !== c ? c : {}
    return (
      (m.origin = "firebase"),
      (m.update = !0),
