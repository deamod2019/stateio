...
{
  ;("use strict")
  ;(Object.defineProperty(t, "__esModule", { value: !0 }), (t.FileDropArea = void 0))
  var i = n(70655),
    r = n(16584),
    o = n(6400),
    a = (function (e) {
        ...
        return (
          ...
          (t.handleDragIn = function (e) {
            ...
            ;(e.preventDefault(),
              e.stopPropagation(),
              t.dragCounter++,
              (null === (n = e.dataTransfer) || void 0 === n ? void 0 : n.items) &&
          ...
          (t.handleDragOut = function (e) {
            ;(e.preventDefault(),
              e.stopPropagation(),
              t.dragCounter--,
              0 === t.dragCounter && t.setState({ drag: !1 }))
          }),
          (t.handleDrop = function (e) {
            ...
            ;(e.preventDefault(),
              e.stopPropagation(),
              t.setState({ drag: !1 }),
              (null === (n = e.dataTransfer) || void 0 === n ? void 0 : n.files) &&
