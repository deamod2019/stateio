...
// (e/*module*/, t/*exports*/, n/*__require*/) =>
{
      ...
      try {
        ...
        throw (
          ...
          E((n) => {
            ;(n.addEventProcessor(
              (e) => (
                t.mechanism && ((0, l.Db)(e, void 0, void 0), (0, l.EG)(e, t.mechanism)),
  ...
  function se(e, t, n, i, r) {
    ...
    if ((0, O.PO)(t) || (0, O.cO)(t)) {
      return (
        ...
        (0, l.EG)(a, { synthetic: !0 }),
        a
      )
    }
    return ((a = ue(e, t, n, i)), (0, l.Db)(a, `${t}`, void 0), (0, l.EG)(a, { synthetic: !0 }), a)
  }
  function ue(e, t, n, i) {
    const r = { message: t }
    if (i && n) {
  ...
  function de() {
    ;(0, ee.o)("unhandledrejection", (e) => {
      ...
      if ($() || (r && r.__sentry_own_request__)) return !0
      const o = (0, O.pt)(r)
        ? {
            exception: {
              values: [
  ...
  function he(e, t, n, i) {
    ...
    return (
      0 === u.length && u.push({ colno: l, filename: d, function: "?", in_app: !0, lineno: c }),
      e
    )
  }
  function pe(e, t, n, i) {
    ;((0, l.EG)(n, { handled: !1, type: i }), e.captureEvent(n, { originalException: t }))
  }
  function fe() {
    const e = (0, _.Gd)(),
      t = e.getClient(),
  ...
  function me(e) {
    return function (...t) {
      ...
      return (
        (t[0] = Q(n, {
          mechanism: { data: { function: (0, R.$P)(e) }, handled: !0, type: "instrument" },
        })),
        e.apply(this, t)
      )
    }
    ...
    captureSession(e) {
      this._isEnabled()
        ? "string" != typeof e.release
          ...
          : (this.sendSession(e), (0, $e.CT)(e, { init: !1 }))
        : ("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) &&
      ...
      return !o && "number" == typeof r && Math.random() > r
        ...
        : this._prepareEvent(e, t, n)
            .then((n) => {
              ...
              if ((t.data && !0 === t.data.__sentry__) || !s) return n
              return (function (e, t) {
  ...
  class et extends Qe {
    ...
    eventFromException(e, t) {
      return (function (e, t, n, i) {
        const r = se(e, t, (n && n.syntheticException) || void 0, i)
        return (
          (0, l.EG)(r),
          (r.level = "error"),
    ...
    eventFromMessage(e, t = "info", n) {
      return (function (e, t, n = "info", i, r) {
        const o = ue(e, t, (i && i.syntheticException) || void 0, r)
  ...
  const st =
    ...
    lt = [
      ...
      (e) => {
        ...
        if (t) {
          ...
          return at(n, e, t[3] ? +t[3] : void 0, t[4] ? +t[4] : void 0)
        }
      },
    ],
    ct =
    ...
    ht = [
      ...
      (e) => {
        ...
        if (t) {
          ...
          let e = t[3],
            n = t[1] || ot
          return (([n, e] = bt(n, e)), at(e, n, t[4] ? +t[4] : void 0, t[5] ? +t[5] : void 0))
        }
      },
    ],
    pt =
    ...
    ft = [
      ...
      (e) => {
        const t = pt.exec(e)
        return t ? at(t[2], t[1] || ot, +t[3], t[4] ? +t[4] : void 0) : void 0
      },
    ],
    ...
    gt = [
      ...
      (e) => {
        const t = _t.exec(e)
        return t ? at(t[2], t[3] || ot, +t[1]) : void 0
      },
    ],
    mt =
    ...
    vt = [
      ...
      (e) => {
        const t = mt.exec(e)
        return t ? at(t[5], t[3] || t[4] || ot, +t[1], +t[2]) : void 0
      },
    ],
    yt = [lt, ht, ft],
    Ct = (0, R.pE)(...yt),
