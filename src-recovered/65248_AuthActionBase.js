...
{
  ;("use strict")
  ;(Object.defineProperty(t, "__esModule", { value: !0 }), (t.AuthActionBase = void 0))
  var i = n(70655),
    r = n(86178),
    o = n(44656),
    a = n(84194),
              ...
              switch (i.label) {
                ...
                case 1:
                  return (
                    ...
                    [4, this.model.post("auth", { user_id: t, signature: o }, !1)]
                  )
                case 2:
                  return (a = i.sent())
                    ? a.token
                ...
                case 3:
                  ;((a = i.sent()), (i.label = 4))
                case 4:
                  return [4, this.proceedToken(null == a ? void 0 : a.token)]
                case 5:
                  return (i.sent(), [2])
              }
            })
