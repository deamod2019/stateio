...
{
  ;("use strict")
  ;(Object.defineProperty(t, "__esModule", { value: !0 }), (t.ShopPreview = void 0))
  var i = n(70655),
    r = n(16584),
    o = n(83430),
    a = n(47283),
      ...
      (0, c.useLayoutEffect)(
        function () {
          var e = [t, n, d],
            ...
            r = [f, _]
          ;(e.map(function (e) {
            return x(C, e.current, null == w ? void 0 : w.data[1])
          }),
            i.map(function (e) {
              return x(b, e.current, null == w ? void 0 : w.data[1])
            }),
            r.map(function (e) {
              if (e.current) {
                var t = e.current.getElementsByTagName("svg")[0]
                if (t) {
                  var n = null == w ? void 0 : w.data[0]
          ...
          var o = e.map(function (e) {
            var i,
              ...
              o = function (i) {
                ...
                null === (s = e.current) || void 0 === s || s.classList.toggle("to-right")
                var v = (
                ...
                e === t
                  ? (null === (l = v.current) ||
                    ...
                    null === (c = v.current) || void 0 === c || c.classList.add("intensity-3"))
                  : e === n
                    ? (null === (h = v.current) ||
                        void 0 === h ||
                      ...
                      null === (p = v.current) || void 0 === p || p.classList.add("intensity-2"))
                    : e === d &&
                      (null === (g = v.current) ||
                        void 0 === g ||
                      ...
                      null === (m = v.current) || void 0 === m || m.classList.add("intensity-1"))
              },
              a = function () {
                ...
                e === t
                  ? (null === (a = f.current) ||
                    ...
                    null === (s = f.current) || void 0 === s || s.classList.add("intensity-1"))
                  : e === n
                    ? (null === (u = f.current) ||
                        void 0 === u ||
                      ...
                      null === (l = f.current) || void 0 === l || l.classList.add("intensity-2"))
                    : e === d &&
                      (null === (c = f.current) ||
                        void 0 === c ||
                      ...
                      null === (h = f.current) || void 0 === h || h.classList.add("intensity-3"))
              }
            return (
              null === (i = e.current) ||
                void 0 === i ||
                i.addEventListener("animationiteration", o),
              null === (r = e.current) || void 0 === r || r.addEventListener("animationstart", a),
              function () {
                var t, n
                ;(null === (t = e.current) ||
                  void 0 === t ||
