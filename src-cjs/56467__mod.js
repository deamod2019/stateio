/**
 * CommonJS restoration prototype for Webpack Module #56467
 * (barrel / re-export module)
 * Generated from src-readable/56467__mod.js
 */
"use strict"
...
function __webpack_module__(e, t, n)
{
  ...
  var i = n(74444) /* 74444__mod */,
    r = n(32238) /* 32238__mod */,
    o = n(53333) /* 53333__mod */,
    a = n(70655) /* 70655__mod */,
    s = n(8463) /* 8463__mod */
  const u = { PHONE: "phone" },
    l = {
  ...
  function P() {
    ...
    return (
      ("undefined" != typeof self &&
        (null === (e = self.location) || undefined === e ? undefined : e.href)) ||
      ""
    )
  }
  function O() {
  ...
  function R() {
    ...
    return (
      ("undefined" != typeof self &&
        (null === (e = self.location) || undefined === e ? undefined : e.protocol)) ||
      null
    )
  }
  class k {
  ...
  async function X(e, t = false) {
    ...
    const a = "object" == typeof o.firebase ? o.firebase : undefined,
      s = null == a ? undefined : a.sign_in_provider
    return {
      claims: o,
      token: r,
      ...
      signInSecondFactor: (null == a ? undefined : a.sign_in_second_factor) || null,
    }
  }
  function q(e) {
    return 1e3 * Number(e)
  ...
  function K(e) {
    const [t, n, r] = e.split(".")
    if (undefined === t || undefined === n || undefined === r)
    ...
    try {
      ...
      return (
        y("Caught error parsing JWT payload as JSON", null == e ? undefined : e.toString()),
        null
      )
    }
  }
  async function $(e, t, n = false) {
    if (n) return t
    try {
      return await t
    } catch (t) {
  ...
  class J {
    ...
    getInterval(e) {
      ...
      }
      {
        ...
        const e =
          (null !== (t = this.user.stsTokenManager.expirationTime) && undefined !== t ? t : 0) -
          Date.now() -
          3e5
        return Math.max(0, e)
      }
    ...
    async iteration() {
      try {
        ...
        return void (
          "auth/network-request-failed" === (null == e ? undefined : e.code) && this.schedule(true)
        )
      }
      this.schedule()
    }
  ...
  async function ee(e) {
    ...
    S(null == r ? undefined : r.users.length, n, "internal-error")
    const o = r.users[0]
    e._notifyReloadListener(o)
    const s = (null === (t = o.providerUserInfo) || undefined === t ? undefined : t.length)
    ...
    const d = e.isAnonymous,
      h = !((e.email && o.passwordHash) || (null == u ? undefined : u.length)),
      p = !!d && h,
      f = {
        uid: o.localId,
  ...
  class ne {
    ...
    updateFromServerResponse(e) {
      ;(S(e.idToken, "internal-error"),
        S(undefined !== e.idToken, "internal-error"),
        S(undefined !== e.refreshToken, "internal-error"))
      const t =
        "expiresIn" in e && undefined !== e.expiresIn
          ? Number(e.expiresIn)
          : (function (e) {
              const t = K(e)
              return (
                S(t, "internal-error"),
                S(undefined !== t.exp, "internal-error"),
                S(undefined !== t.iat, "internal-error"),
  ...
  function ie(e, t) {
    S("string" == typeof e || undefined === e, "internal-error", { appName: t })
  }
  class re {
    constructor(e) {
      ...
      ;((this.providerId = "firebase"),
        ...
        (this.metadata = new Q(r.createdAt || undefined, r.lastLoginAt || undefined)))
    }
    async getIdToken(e) {
    ...
    async _updateTokensIfNecessary(e, t = false) {
      ...
      ;(e.idToken &&
        ...
        (this.stsTokenManager.updateFromServerResponse(e), (n = true)),
        t && (await ee(this)),
        await this.auth._persistUserIfCurrent(this),
    ...
    static _fromJSON(e, t) {
      var n, i, r, o, a, s, u, l
      const c = null !== (n = t.displayName) && undefined !== n ? n : undefined,
        d = null !== (i = t.email) && undefined !== i ? i : undefined,
        h = null !== (r = t.phoneNumber) && undefined !== r ? r : undefined,
        p = null !== (o = t.photoURL) && undefined !== o ? o : undefined,
        f = null !== (a = t.tenantId) && undefined !== a ? a : undefined,
        _ = null !== (s = t._redirectEventId) && undefined !== s ? s : undefined,
        g = null !== (u = t.createdAt) && undefined !== u ? u : undefined,
        m = null !== (l = t.lastLoginAt) && undefined !== l ? l : undefined,
    ...
    static async _fromIdTokenResponse(e, t, n = false) {
      const i = new ne()
  ...
  class ue {
    ...
    async setPersistence(e) {
      ...
      return (
        ...
        (this.persistence = e),
        t ? this.setCurrentUser(t) : undefined
      )
    }
    delete() {
  ...
  function le(e) {
    ...
    if (fe(t)) return "Android"
    {
      const t = /([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,
        n = e.match(t)
      if (2 === (null == n ? undefined : n.length)) return n[1]
    }
    return "Other"
  }
  function ce(e = (0, i.z$)()) {
    ...
    async runMiddleware(e) {
      ...
      try {
        ...
        throw this.auth._errorFactory.create("login-blocked", {
          originalMessage: null == e ? undefined : e.message,
        })
      }
    }
  }
  class be {
      ...
      return (
        ...
        (this._initializationPromise = this.queue(async () => {
          ...
          if (
            ...
            if (
              null === (n = this._popupRedirectResolver) || undefined === n
                ? undefined
            ...
            ;(await this.initializeCurrentUser(t),
              (this.lastNotifiedUid =
                (null === (i = this.currentUser) || undefined === i ? undefined : i.uid) || null),
    ...
    async _onStorageEvent() {
      ...
      return this.currentUser || e
        ? this.currentUser && e && this.currentUser.uid === e.uid
          ...
          : void (await this._updateCurrentUser(e, true))
        : undefined
    }
    async initializeCurrentUser(e) {
      ...
      if (e && this.config.authDomain) {
        ...
        const n = null === (t = this.redirectUser) || undefined === t ? undefined : t._redirectEventId,
          o = null == i ? undefined : i._redirectEventId,
          a = await this.tryRedirectSignIn(e)
        ;(n && n !== o) || !(null == a ? undefined : a.user) || ((i = a.user), (r = true))
      }
    ...
    async reloadAndSetCurrentUserOrClear(e) {
      try {
        ...
        if ("auth/network-request-failed" !== (null == e ? undefined : e.code))
    ...
    toJSON() {
      ...
      return {
        ...
        appName: this.name,
        currentUser: null === (e = this._currentUser) || undefined === e ? undefined : e.toJSON(),
      }
    }
    ...
    async _redirectUserForId(e) {
      ...
      return (
        ...
        (null === (t = this._currentUser) || undefined === t ? undefined : t._redirectEventId) === e
          ? this._currentUser
          : (null === (n = this.redirectUser) || undefined === n ? undefined : n._redirectEventId) === e
            ? this.redirectUser
            : null
      )
    }
    ...
    notifyAuthListeners() {
      ...
      const n =
        null !== (t = null === (e = this.currentUser) || undefined === e ? undefined : e.uid) &&
        undefined !== t
          ? t
          : null
    ...
    async _getAdditionalHeaders() {
      ...
      const n = await (null ===
        (e = this.heartbeatServiceProvider.getImmediate({ optional: true })) || undefined === e
        ? undefined
  ...
  function Te(e, t, n) {
    ...
    const r = !!(null == n ? undefined : n.disableWarnings),
      o = Se(t),
  ...
  class Pe extends Ee {
    ...
    static fromJSON(e) {
      ...
      if ((null == t ? undefined : t.email) && (null == t ? undefined : t.password)) {
    ...
    async _getIdTokenResponse(e) {
      switch (this.signInMethod) {
        case "password":
          ...
          })(e, { returnSecureToken: true, email: this._email, password: this._password })
        case "emailLink":
          return (async function (e, t) {
  ...
  class Re extends Ee {
    ...
    static fromJSON(e) {
      ...
      const o = new Re(n, i)
      return (
        (o.idToken = r.idToken || undefined),
        (o.accessToken = r.accessToken || undefined),
        (o.secret = r.secret),
        (o.nonce = r.nonce),
    ...
    _getReauthenticationResolver(e) {
      ...
      return ((t.autoCreate = false), Oe(e, t))
    }
    buildRequest() {
      const e = { requestUri: "http://localhost", returnSecureToken: true }
  ...
  class De {
    constructor(e) {
      ...
      const u = (0, i.zd)((0, i.pd)(e)),
        l = null !== (t = u.apiKey) && undefined !== t ? t : null,
        c = null !== (n = u.oobCode) && undefined !== n ? n : null,
        d = (function (e) {
          switch (e) {
            case "recoverEmail":
        ...
        })(null !== (r = u.mode) && undefined !== r ? r : null)
      ;(S(l && c && d, "argument-error"),
        (this.apiKey = l),
        (this.operation = d),
        (this.code = c),
        (this.continueUrl = null !== (o = u.continueUrl) && undefined !== o ? o : null),
        (this.languageCode = null !== (a = u.languageCode) && undefined !== a ? a : null),
        (this.tenantId = null !== (s = u.tenantId) && undefined !== s ? s : null))
    }
    static parseLink(e) {
      const t = (function (e) {
  ...
  class qe {
    ...
    static async _fromIdTokenResponse(e, t, n, i = false) {
    ...
    static async _forOperation(e, t, n) {
      await e._updateTokensIfNecessary(n, true)
      const i = Ke(n)
  ...
  async function $e(e) {
    ...
    if (
      ...
      null === (t = n.currentUser) || undefined === t ? undefined : t.isAnonymous)
    )
      return new qe({ user: n.currentUser, providerId: null, operationType: "signIn" })
    const i = await Xe(n, { returnSecureToken: true }),
      r = await qe._fromIdTokenResponse(n, "signIn", i, true)
  ...
  class Je extends i.ZR {
    constructor(e, t, n, i) {
      ...
      ;(super(t.code, t.message),
        ...
        (this.customData = {
          appName: e.name,
          tenantId: null !== (r = e.tenantId) && undefined !== r ? r : undefined,
  ...
  async function rt(e, t, n = false) {
    ...
    try {
      ...
      throw ("auth/user-not-found" === (null == e ? undefined : e.code) && C(i, "user-mismatch"), e)
    }
  }
  async function ot(e, t, n = false) {
    const i = "signIn",
      r = await Qe(e, i, t),
  ...
  async function st(e, t) {
    const n = (0, i.m9)(e)
    return (await it(false, n, t.providerId), nt(n, t))
  }
  ...
  async function lt(e, t) {
    const n = we(e),
      ...
      })(n, { token: t, returnSecureToken: true }),
  ...
  function ht(e, t, n) {
    var i
    ;(S((null === (i = n.url) || undefined === i ? undefined : i.length) > 0, e, "invalid-continue-uri"),
      S(
        undefined === n.dynamicLinkDomain || n.dynamicLinkDomain.length > 0,
        e,
        "invalid-dynamic-link-domain",
      ),
      (t.continueUrl = n.url),
  ...
  async function vt(e, t, n) {
    const i = we(e),
      r = await Xe(i, { returnSecureToken: true, email: t, password: n }),
  ...
  function bt(e, t) {
    const n = De.parseLink(t)
    return "EMAIL_SIGNIN" === (null == n ? undefined : n.operation)
  }
  ...
  async function Lt(e, { displayName: t, photoURL: n }) {
    if (undefined === t && undefined === n) return
    const r = (0, i.m9)(e),
      o = { idToken: await r.getIdToken(), displayName: t, photoUrl: n, returnSecureToken: true },
      a = await $(
        r,
        (async function (e, t) {
          return G(e, "POST", "/v1/accounts:update", t)
  ...
  async function It(e, t, n) {
    const { auth: i } = e,
      r = { idToken: await e.getIdToken(), returnSecureToken: true }
    ;(t && (r.email = t), n && (r.password = n))
    const o = await $(e, Ie(i, r))
    await e._updateTokensIfNecessary(o, true)
  }
  class Mt {
    constructor(e, t, n = {}) {
  ...
  class Rt extends Pt {
    constructor(e, t) {
      super(
        ...
        "github.com",
        t,
        "string" == typeof (null == t ? undefined : t.login) ? (null == t ? undefined : t.login) : null,
      )
    }
  }
  class kt extends Mt {
  ...
  function Dt(e) {
    ...
    return t.isAnonymous && !n
      ? { providerId: null, isNewUser: false, profile: null }
      : (function (e) {
          var t, n
          if (!e) return null
          ...
          if (!i && (null == e ? undefined : e.idToken)) {
            const i =
              null === (n = null === (t = K(e.idToken)) || undefined === t ? undefined : t.firebase) ||
              undefined === n
                ? undefined
                : n.sign_in_provider
  ...
  class zt {
    ...
    static fromJSON(e) {
      var t, n
      if (null == e ? undefined : e.multiFactorSession) {
        if (null === (t = e.multiFactorSession) || undefined === t ? undefined : t.pendingCredential)
          return zt._fromMfaPendingCredential(e.multiFactorSession.pendingCredential)
        if (null === (n = e.multiFactorSession) || undefined === n ? undefined : n.idToken)
  ...
  function Wt(e, t) {
    ...
    return (
      ...
      S(
        null === (n = o.customData._serverResponse) || undefined === n
          ? undefined
  ...
  class Xt {
    ...
    async unenroll(e) {
      ...
      try {
        ...
        if ("auth/user-token-expired" !== (null == e ? undefined : e.code)) throw e
      }
    }
  }
  ...
  class Jt {
    ...
    _isAvailable() {
      try {
        return this.storage
          ? (this.storage.setItem($t, "1"), this.storage.removeItem($t), Promise.resolve(true))
  ...
  class rn {
    ...
    async handleEvent(e) {
      ...
      if (!(null == o ? undefined : o.size)) return
      ...
      const a = Array.from(o).map(async (e) => e(t.origin, r)),
        s = await (function (e) {
          return Promise.all(
            e.map(async (e) => {
              try {
                return { fulfilled: true, value: await e }
              } catch (e) {
  ...
  function un() {
    return undefined !== sn().WorkerGlobalScope && "function" == typeof sn().importScripts
  }
  ...
  async function _n(e, t, n) {
    const i = pn(e, true).put({ [dn]: t, value: n })
    return new hn(i).toPromise()
  }
  function gn(e, t) {
    const n = pn(e, true).delete(t)
  ...
  class mn {
    ...
    async initializeSender() {
      ...
      if (
        ((this.activeServiceWorker = await (async function () {
          if (!(null === navigator || undefined === navigator ? undefined : navigator.serviceWorker))
            return null
          try {
      ...
      n &&
        (null === (e = n[0]) || undefined === e ? undefined : e.fulfilled) &&
        (null === (t = n[0]) || undefined === t ? undefined : t.value.includes("keyChanged")) &&
    ...
    async notifyServiceWorker(e) {
      ...
      if (
        ...
        this.activeServiceWorker &&
        ((null ===
          (t = null === navigator || undefined === navigator ? undefined : navigator.serviceWorker) ||
        undefined === t
          ? undefined
    ...
    async _isAvailable() {
      try {
        ...
        const e = await fn()
        return (await _n(e, $t, "1"), await gn(e, $t), true)
      } catch (e) {}
      return false
    }
    ...
    async _get(e) {
      const t = await this._withRetries((t) =>
        (async function (e, t) {
          const n = pn(e, false).get(t),
            i = await new hn(n).toPromise()
          return undefined === i ? null : i.value
        })(t, e),
      )
  ...
  function yn(e) {
    return new Promise((t, n) => {
      ...
      ;(i.setAttribute("src", e),
        ...
        (null !==
          (o =
            null === (r = document.getElementsByTagName("head")) || undefined === r ? undefined : r[0]) &&
        undefined !== o
          ? o
          : document
        ).appendChild(i))
  ...
  class wn {
    ...
    reset(e) {
      var t
      const n = e || bn
      ;(null === (t = this._widgets.get(n)) || undefined === t || t.delete(), this._widgets.delete(n))
    }
    getResponse(e) {
      var t
      const n = e || bn
      return (null === (t = this._widgets.get(n)) || undefined === t ? undefined : t.getResponse()) || ""
    }
    async execute(e) {
      var t
      const n = e || bn
      return (null === (t = this._widgets.get(n)) || undefined === t || t.execute(), "")
    }
  }
  class xn {
    constructor(e, t, n) {
  ...
  class Ln {
    constructor() {
      ...
      ;((this.hostLanguage = ""),
        (this.counter = 0),
        (this.librarySeparatelyLoaded = !!(null === (e = sn().grecaptcha) || undefined === e
          ? undefined
          : e.render)))
    }
    load(e, t = "") {
    ...
    shouldResolveImmediately(e) {
      var t
      return (
        !!(null === (t = sn().grecaptcha) || undefined === t ? undefined : t.render) &&
    ...
    try {
      ...
      if (
        ...
        }
        {
          ...
          const n =
            (null === (i = o.multiFactorHint) || undefined === i ? undefined : i.uid) || o.multiFactorUid
  ...
  class Vn {
    ...
    async onAuthEvent(e) {
      ...
      const s = {
        ...
        requestUri: t,
        sessionId: n,
        tenantId: r || undefined,
        postBody: i || undefined,
        user: this.user,
  ...
  class Xn extends Vn {
    ...
    get eventId() {
      var e
      return (null === (e = this.authWindow) || undefined === e ? undefined : e.associatedEvent) || null
    }
    cancel() {
    ...
    pollUserCancellation() {
      const e = () => {
        var t, n
        ;(
          null === (n = null === (t = this.authWindow) || undefined === t ? undefined : t.window) ||
          undefined === n
            ? undefined
            : n.closed
        )
  ...
  function ii(e, t, n) {
    return (async function (e, t, n) {
      ...
      x(r.auth, t, Ue)
      const o = Fn(r.auth, n)
      ;(await it(false, r, t.providerId), await $n(o, r.auth))
      const a = await ai(r)
      return o._openRedirect(r.auth, t, "linkViaRedirect", a)
    })(e, t, n)
  }
  async function ri(e, t) {
    return (await we(e)._initializationPromise, oi(e, t, false))
  }
  async function oi(e, t, n = false) {
    const i = we(e),
      r = Fn(i, t),
      o = new Kn(i, r, n),
      a = await o.execute()
      ...
      return (
        this.consumers.forEach((n) => {
          this.isEventForConsumer(e, n) &&
            ((t = true), this.sendToConsumer(e, n), this.saveEventToCache(e))
        }),
        this.hasHandledPotentialRedirect ||
          ...
          t || ((this.queuedRedirectEvent = e), (t = true))),
        t
      )
    }
    sendToConsumer(e, t) {
      ...
      if (e.error && !li(e)) {
        const i =
          (null === (n = e.error.code) || undefined === n ? undefined : n.split("auth/")[1]) ||
          "internal-error"
  ...
  function li({ type: e, error: t }) {
    return "unknown" === e && "auth/no-auth-event" === (null == t ? undefined : t.code)
  }
      ...
      (gi =
        ...
        (function (e) {
          return new Promise((t, n) => {
            ...
            if (
              null === (r = null === (i = sn().gapi) || undefined === i ? undefined : i.iframes) ||
              undefined === r
                ? undefined
                : r.Iframe
            )
              ...
              if (!(null === (o = sn().gapi) || undefined === o ? undefined : o.load)) {
  ...
  function Ti(e, t, n, r = 500, o = 600) {
    ...
    if (
      (function (e = (0, i.z$)()) {
        var t
        return me(e) && !!(null === (t = window.navigator) || undefined === t ? undefined : t.standalone)
      })(c) &&
      "_self" !== u
    )
      return (
        (function (e, t) {
          ...
          ;(i.initMouseEvent("click", true, true, window, 1, 0, 0, 0, 0, false, false, false, false, 1, null),
            n.dispatchEvent(i))
        })(t || "", u),
        new xi(null)
      )
  ...
  function Ei(e, t, n, o, a, s) {
    ...
    const l = u
    for (const e of Object.keys(l)) undefined === l[e] && delete l[e]
  ...
  const Ii = class {
    ...
    async _openPopup(e, t, n, i) {
      var r
      E(
        null === (r = this.eventManagers[e._key()]) || undefined === r ? undefined : r.manager,
    ...
    async initAndGetManager(e) {
            ...
            t.open(
              ...
              (t) =>
                new Promise(async (n, i) => {
                  await t.restyle({ setHideOnLeave: false })
      ...
      return (
        t.register(
          "authEvent",
          (t) => {
            S(null == t ? undefined : t.authEvent, e, "invalid-auth-event")
    ...
    _isIframeWebStorageSupported(e, t) {
      this.iframes[e._key()].send(
        ...
        (n) => {
          var i
          const r = null === (i = null == n ? undefined : n[0]) || undefined === i ? undefined : i[Ai]
          ;(undefined !== r && t(!!r), C(e, "internal-error"))
        },
        gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER,
      )
    }
  ...
  class Ni {
    ...
    getUid() {
      ...
      return (
        ...
        (null === (e = this.auth.currentUser) || undefined === e ? undefined : e.uid) || null
      )
    }
    async getToken(e) {
      if (
    ...
    addAuthTokenListener(e) {
      ...
      const t = this.auth.onIdTokenChanged((t) => {
        e((null == t ? undefined : t.stsTokenManager.accessToken) || null)
      })
    ...
    if (o) {
      const e =
        ...
        async (e) => {
          ...
          if (n && n > Di) return
          const i = null == t ? undefined : t.token
          Bi !== i &&
            ((Bi = i),
            await fetch(a, {
        ...
        (e, { options: t }) => {
          ...
          return ((e, n) => {
            ;(S(r && !r.includes(":"), "invalid-api-key", { appName: e.name }),
              S(!(null == o ? undefined : o.includes(":")), "argument-error", { appName: e.name }))
            const i = {
                apiKey: r,
                authDomain: o,
                clientPlatform: Ui,
            ...
            return (
              (function (e, t) {
                const n = (null == t ? undefined : t.persistence) || [],
                  i = (Array.isArray(n) ? n : [n]).map(I)
                ;((null == t ? undefined : t.errorMap) && e._updateErrorMap(t.errorMap),
                  e._initializeWithPersistence(i, null == t ? undefined : t.popupRedirectResolver))
              })(a, t),
              a
            )
          })(n, i)
