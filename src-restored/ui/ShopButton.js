/**
 * Restored source for Webpack Module #82978.
 *
 * Home-screen shop button with optional unstored-item notification marker.
 */
"use strict"
    ...
    __assign(
      {
        ...
        className: classNames("btn", "btn-blue", "shop-button", props.className),
        type: "button",
      },
      {
        children: [
          ...
          props.showNotification
            ? jsxRuntime.jsx(ExclamationMarkNotificator, {
