/**
 * Restored source for Webpack Module #74083.
 */
"use strict"

const ShopType = {
  BUILDING: "ShopType.BUILDING",
  FIGHTER: "ShopType.FIGHTER",
  COLOR: "ShopType.COLOR",
}
...
const UIConstants = {
  ...
  shop: { tabTypes: [ShopType.BUILDING, ShopType.FIGHTER, ShopType.COLOR], defaultTabType: ShopType.BUILDING },
}

module.exports = { ShopType, UIConstants }
