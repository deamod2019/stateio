...
// (e/*module*/, t/*exports*/, n/*__require*/) =>
{
  ...
  ;(!(function () {
    ...
    r.prototype = {
      ...
      volume: function (e) {
        var t = this || o
        if (((e = parseFloat(e)), t.ctx || p(), undefined !== e && e >= 0 && e <= 1)) {
        ...
        if (!e._audioUnlocked && e.ctx) {
          ...
          var t = function (n) {
            for (; e._html5AudioPool.length < e.html5PoolSize; )
              try {
                var i = new Audio()
                ;((i._unlocked = true), e._releaseHtml5Audio(i))
              } catch (n) {
                e.noAudio = true
                break
              }
            for (var r = 0; r < e._howls.length; r++)
              if (!e._howls[r]._webAudio)
                for (var o = e._howls[r]._getSoundIds(), a = 0; a < o.length; a++) {
                  ...
                  s && s._node && !s._node._unlocked && ((s._node._unlocked = true), s._node.load())
                }
            e._autoResume()
            var u = e.ctx.createBufferSource()
            ;((u.buffer = e._scratchBuffer),
              u.connect(e.ctx.destination),
              undefined === u.start ? u.noteOn(0) : u.start(0),
      ...
      _autoSuspend: function () {
        var e = this
        if (e.autoSuspend && e.ctx && undefined !== e.ctx.suspend && o.usingWebAudio) {
      ...
      _autoResume: function () {
        var e = this
        if (e.ctx && undefined !== e.ctx.resume && o.usingWebAudio)
          return (
            "running" === e.state && "interrupted" !== e.ctx.state && e._suspendTimer
              ...
              : "suspended" === e.state || ("running" === e.state && "interrupted" === e.ctx.state)
                ...
                : "suspending" === e.state && (e._resumeAfterSuspend = true),
            e
          )
      },
    }
    ...
    a.prototype = {
      init: function (e) {
        ...
        return (
          ...
          undefined !== o.ctx && o.ctx && o.autoUnlock && o._unlockAudio(),
          o._howls.push(t),
          t._autoplay &&
            t._queue.push({
              event: "play",
      ...
      play: function (e, t) {
        ...
        if ("number" == typeof e) ((i = e), (e = null))
          ...
          if (undefined === e && ((e = "__default"), !n._playLock)) {
        ...
        if (!(l >= p)) {
          ...
          if (n._webAudio) {
            ...
            "running" === o.state && "interrupted" !== o.ctx.state
              ? g()
              : ((n._playLock = true), n.once("resume", g), n._clearTimer(s._id))
          } else {
            var m = function () {
              ;((_.currentTime = l),
              ...
              try {
                ...
                if (
                  ...
                  (i instanceof Promise || "function" == typeof i.then)
                    ...
                    : t || ((n._playLock = false), f(), n._emit("play", s._id)),
                  (_.playbackRate = s._rate),
                  _.paused)
                )
                  return void n._emit(
                ...
                "__default" !== e || s._loop
                  ...
                  : ((n._endTimers[s._id] = function () {
                      ;(n._ended(s), _.removeEventListener("ended", n._endTimers[s._id], false))
                    }),
            ...
            if (_.readyState >= 3 || v) m()
              ...
              var y = function () {
                ;((n._state = "loaded"), m(), _.removeEventListener(o._canPlayEvent, y, false))
              }
              ;(_.addEventListener(o._canPlayEvent, y, false), n._clearTimer(s._id))
            }
          }
          return s._id
        }
        ...
        for (var n = t._getSoundIds(e), i = 0; i < n.length; i++) {
          ...
          if (
            ...
            if (t._webAudio) {
              ...
              ;(undefined === r._node.bufferSource.stop
            ...
            o._node &&
              (n._webAudio
                ? o._node.bufferSource &&
                  (undefined === o._node.bufferSource.stop
      ...
      volume: function () {
        ...
        ;(undefined === t && (i._volume = e), (t = i._getSoundIds(t)))
      ...
      fade: function (e, t, n, i) {
        ...
        for (var a = r._getSoundIds(i), s = 0; s < a.length; s++) {
          ...
          if (u) {
            ...
            r._startFadeInterval(u, e, t, n, a[s], undefined === i)
          }
        }
        return r
      },
          ...
          (n = i._soundById(o[a])) &&
            ...
            i._webAudio &&
              ...
              e &&
                ...
                i.playing(o[a]) && (i.pause(o[a], true), i.play(o[a], true)))))
        return i
      },
      rate: function () {
        var e,
        ...
        ;(undefined === t && (i._rate = e), (t = i._getSoundIds(t)))
        for (var u = 0; u < t.length; u++)
      ...
      seek: function () {
        ...
        if (s) {
          ...
          var d = function () {
            ;(c && n.play(t, true), n._emit("seek", t))
          }
          if (c && !n._webAudio) {
            var h = function () {
      ...
      playing: function (e) {
        ...
        for (var i = 0; i < t._sounds.length; i++) if (!t._sounds[i]._paused) return true
        return false
      },
      duration: function (e) {
        var t = this,
      ...
      _ended: function (e) {
        ...
        if (
          (t._emit("end", e._id),
          !t._webAudio && i && t.stop(e._id, true).play(e._id),
          t._webAudio && i)
        ) {
          ;(t._emit("play", e._id),
            (e._seek = e._start || 0),
        ...
        return (
          t._webAudio &&
            ...
            o._autoSuspend()),
          t._webAudio || i || t.stop(e._id, true),
          t
        )
      },
    ...
    s.prototype = {
      ...
      create: function () {
        ...
        return (
          t._webAudio
            ? ((e._node =
                undefined === o.ctx.createGain ? o.ctx.createGainNode() : o.ctx.createGain()),
            ...
            : o.noAudio ||
              ...
              e._node.addEventListener(o._canPlayEvent, e._loadFn, false),
              (e._endFn = e._endListener.bind(e)),
              e._node.addEventListener("ended", e._endFn, false),
              (e._node.src = t._src),
              (e._node.preload = true === t._preload ? "auto" : t._preload),
      ...
      _loadListener: function () {
        ...
        ;((t._duration = Math.ceil(10 * e._node.duration) / 10),
          ...
          e._node.removeEventListener(o._canPlayEvent, e._loadFn, false))
      },
      ...
      l = function (e) {
        ...
        if (/^data:[^;]+;base64,/.test(t)) {
          ...
          ;(o.open(e._xhr.method, t, true),
            ...
            (o.onerror = function () {
              e._webAudio &&
                ((e._html5 = true), (e._webAudio = false), (e._sounds = []), delete u[t], e.load())
            }),
            c(o))
        }
      },
      ...
      p = function () {
        if (o.usingWebAudio) {
          ...
          if (e && n && n < 9) {
            ...
            o._navigator && !i && (o.usingWebAudio = false)
          }
          ;(o.usingWebAudio &&
            ((o.masterGain =
              undefined === o.ctx.createGain ? o.ctx.createGainNode() : o.ctx.createGain()),
          ...
          return i.ctx && i.ctx.listener
            ? ((t = "number" != typeof t ? i._pos[1] : t),
              ...
              "number" != typeof e
                ? i._pos
                : ((i._pos = [e, t, n]),
                  undefined !== i.ctx.listener.positionX
          ...
          return (
            ...
            "number" != typeof e
              ...
              : ((a._orientation = [e, t, n, i, r, o]),
                undefined !== a.ctx.listener.forwardX
        ...
        (Howl.prototype.init =
          ...
          function (t) {
            ...
            return (
              ...
              (n._pos = t.pos || null),
              (n._pannerAttr = {
                coneInnerAngle: undefined !== t.coneInnerAngle ? t.coneInnerAngle : 360,
                coneOuterAngle: undefined !== t.coneOuterAngle ? t.coneOuterAngle : 360,
                coneOuterGain: undefined !== t.coneOuterGain ? t.coneOuterGain : 0,
                distanceModel: undefined !== t.distanceModel ? t.distanceModel : "inverse",
                maxDistance: undefined !== t.maxDistance ? t.maxDistance : 1e4,
                panningModel: undefined !== t.panningModel ? t.panningModel : "HRTF",
                refDistance: undefined !== t.refDistance ? t.refDistance : 1,
                rolloffFactor: undefined !== t.rolloffFactor ? t.rolloffFactor : 1,
              }),
            ...
            if (u) {
              ...
              ;((u._orientation = [e, n, i]),
                u._node &&
                  ...
                  undefined !== u._panner.orientationX
        ...
        (Howl.prototype.pannerAttr = function () {
          ...
          if (1 === o.length) {
            ...
            ;((e = o[0]),
              undefined === n &&
                ...
                (r._pannerAttr = {
                  coneInnerAngle:
                    undefined !== e.pannerAttr.coneInnerAngle
                      ? e.pannerAttr.coneInnerAngle
                      : r._coneInnerAngle,
                  coneOuterAngle:
                    undefined !== e.pannerAttr.coneOuterAngle
                      ? e.pannerAttr.coneOuterAngle
                      : r._coneOuterAngle,
                  coneOuterGain:
                    undefined !== e.pannerAttr.coneOuterGain
                      ? e.pannerAttr.coneOuterGain
                      : r._coneOuterGain,
                  distanceModel:
                    undefined !== e.pannerAttr.distanceModel
                      ? e.pannerAttr.distanceModel
                      : r._distanceModel,
                  maxDistance:
                    undefined !== e.pannerAttr.maxDistance ? e.pannerAttr.maxDistance : r._maxDistance,
                  refDistance:
                    undefined !== e.pannerAttr.refDistance ? e.pannerAttr.refDistance : r._refDistance,
                  rolloffFactor:
                    undefined !== e.pannerAttr.rolloffFactor
                      ? e.pannerAttr.rolloffFactor
                      : r._rolloffFactor,
                  panningModel:
                    undefined !== e.pannerAttr.panningModel
          ...
          for (var a = r._getSoundIds(n), s = 0; s < a.length; s++)
            if ((i = r._soundById(a[s]))) {
              var u = i._pannerAttr
              u = {
                coneInnerAngle: undefined !== e.coneInnerAngle ? e.coneInnerAngle : u.coneInnerAngle,
                coneOuterAngle: undefined !== e.coneOuterAngle ? e.coneOuterAngle : u.coneOuterAngle,
                coneOuterGain: undefined !== e.coneOuterGain ? e.coneOuterGain : u.coneOuterGain,
                distanceModel: undefined !== e.distanceModel ? e.distanceModel : u.distanceModel,
                maxDistance: undefined !== e.maxDistance ? e.maxDistance : u.maxDistance,
                refDistance: undefined !== e.refDistance ? e.refDistance : u.refDistance,
                rolloffFactor: undefined !== e.rolloffFactor ? e.rolloffFactor : u.rolloffFactor,
                panningModel: undefined !== e.panningModel ? e.panningModel : u.panningModel,
              }
              var l = i._panner
              l
            ...
            return (
              ...
              t._stereo
                ...
                : t._pos
                  ...
                  : t._panner &&
                    (t._panner.disconnect(0), (t._panner = undefined), n._refreshBuffer(t)),
              e.call(this)
            )
          }
      ...
      var t = function (e, t) {
        ;("spatial" === (t = t || "spatial")
          ? ((e._panner = Howler.ctx.createPanner()),
            ...
            undefined !== e._panner.orientationX
