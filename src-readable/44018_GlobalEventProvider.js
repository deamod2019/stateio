...
{
  ;("use strict")
  ;(Object.defineProperty(t, "__esModule", { value: true }), (t.GlobalEventProvider = undefined))
  var i = n(70655) /* 70655__mod */,
    r = n(86178) /* 86178__mod */,
    o = n(86700) /* 86700_MetadataReader */,
    a = n(96488) /* 96488_EventDispatcher */,
    s = (function () {
      function e() {
        this.listenersMap = {}
      }
      return (
        ...
        (e.prototype.unMapListenerToEvent = function (e, t, n) {
          ...
          if (i) {
            var r = i.indexOf(t)
            if (r > -1) return (i.splice(r, 1), 0 === i.length && delete n[e], true)
          }
          return false
        }),
        i.__decorate(
