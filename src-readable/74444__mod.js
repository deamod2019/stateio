...
// (e/*module*/, t/*exports*/, n/*__require*/) =>
{
  ...
  const i = function (e) {
    ...
    o = function (e) {
      return (function (e) {
        const t = i(e)
        return r.encodeByteArray(t, true)
      })(e).replace(/\./g, "")
    },
    a = function (e) {
      try {
        return r.decodeString(e, true)
      } catch (e) {
  ...
  function p() {
    return new Promise((e, t) => {
      try {
        ...
        ;((r.onsuccess = () => {
          ;(r.result.close(), n || self.indexedDB.deleteDatabase(i), e(true))
        }),
          (r.onupgradeneeded = () => {
            n = false
          }),
          (r.onerror = () => {
            var e
            t((null === (e = r.error) || undefined === e ? undefined : e.message) || "")
          }))
      } catch (e) {
        t(e)
      }
  ...
  const _ = () =>
    ...
    m = (e) => {
      var t, n
      return null === (n = null === (t = g()) || undefined === t ? undefined : t.emulatorHosts) ||
        undefined === n
        ? undefined
        : n[e]
    },
    v = () => {
      var e
      return null === (e = g()) || undefined === e ? undefined : e.config
    },
    y = (e) => {
      var t
      return null === (t = g()) || undefined === t ? undefined : t[`_${e}`]
    }
  class C {
    constructor() {
      ;((this.reject = () => {}),
  ...
  function S(e, t) {
    ...
    for (const r of n) {
      ...
      const n = e[r],
        o = t[r]
      if (L(n) && L(o)) {
        if (!S(n, o)) return false
      } else if (n !== o) return false
    }
    for (const e of i) if (!n.includes(e)) return false
    return true
  }
  function L(e) {
  ...
  class P {
    ...
    subscribe(e, t, n) {
      let i
      if (undefined === e && undefined === t && undefined === n) throw new Error("Missing Observer.")
      ;((i = (function (e, t) {
        if ("object" != typeof e || null === e) return false
        for (const n of t) if (n in e && "function" == typeof e[n]) return true
        return false
      })(e, ["next", "error", "complete"])
        ? e
        : { next: e, error: t, complete: n }),
        undefined === i.next && (i.next = O),
        undefined === i.error && (i.error = O),
        undefined === i.complete && (i.complete = O))
    ...
    unsubscribeOne(e) {
      undefined !== this.observers &&
        undefined !== this.observers[e] &&
        (delete this.observers[e],
        (this.observerCount -= 1),
        0 === this.observerCount && undefined !== this.onNoObservers && this.onNoObservers(this))
    }
    forEachObserver(e) {
    ...
    sendOne(e, t) {
      this.task.then(() => {
        if (undefined !== this.observers && undefined !== this.observers[e])
          try {
            t(this.observers[e])
          } catch (e) {
