...
{
  ;("use strict")
  ;(Object.defineProperty(t, "__esModule", { value: true }), (t.Mediator = undefined))
      ...
      return (
        ...
        (t.prototype.removeViewListener = function (e, t) {
          ...
          this.unMapListenerToEvent(e, t, this.viewListenersMap)
            ? null === (n = this.view) || undefined === n || n.off(e, t)
          ...
          if (a) {
            try {
              for (var s = i.__values(a), u = s.next(); !u.done; u = s.next()) {
                var l = u.value
                null === (r = this.view) || undefined === r || r.off(e, l)
              }
            } catch (e) {
              t = { error: e }
            } finally {
        ...
        (t.prototype.bindDebug = function () {
          var e,
            t = null === (e = this.view) || undefined === e ? undefined : e.debugId
          undefined !== t && (window[t] = this.view)
        }),
        (t.prototype.unbindDebug = function () {
          var e,
            t = null === (e = this.view) || undefined === e ? undefined : e.debugId
          undefined !== t && delete window[t]
        }),
        (t = i.__decorate([(0, r.injectable)()], t))
      )
    })(n(44656) /* 44656__mod */.GlobalEventProvider)
  t.Mediator = a
}
