...
// (e/*module*/, t/*exports*/, n/*__require*/) =>
{
  ...
  var i,
    ...
    z = function (e) {
      ...
      return (
        (t && (t.width || t.height)) || e.getBBox === V || (t = V.call(e, true)),
        !t || t.width || t.x || t.y
          ? t
          : {
              x: +Z(e, ["x", "cx", "x1"]) || 0,
    ...
    le = function (e, t) {
      ...
      return (
        ...
        n.svg &&
          ...
          ue(e, P || q, !!P || n.originIsAbsolute, false !== n.smooth, b)),
        (y = n.xOrigin || 0),
        (C = n.yOrigin || 0),
        b !== ie &&
          ((S = b[0]),
              ...
              if (
                ...
                if (
                  ...
                  T ||
                    ...
                    (L = false !== t.smoothOrigin && S.smooth),
                    ((T = this._pt =
              ...
              if (b || ((u || 0 === u) && (l || 0 === l) && !v.test(s) && f in D))
                (u || (u = 0),
                  ...
                  (this._pt = new d.PropTween(
                    ...
                    b || ("px" !== g && "zIndex" !== f) || false === t.autoRound ? C : x,
                  )),
                  (this._pt.u = g || 0),
