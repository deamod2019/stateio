...
// (e/*module*/, t/*exports*/, n/*__require*/) =>
{
  ...
  var o,
    ...
    b = { duration: 0.5, overwrite: false, delay: 0 },
    w = 1e8,
    x = 1e-8,
    T = 2 * Math.PI,
    S = T / 4,
    ...
    ee = { suppressEvents: true, isStart: true, kill: false },
    te = { suppressEvents: true, kill: false },
    ne = { suppressEvents: true },
    ie = {},
    re = [],
    oe = {},
    ae = {},
    ...
    ye = function () {
      ...
      for (oe = {}, re.length = 0, e = 0; e < n; e++)
        (t = i[e]) && t._lazy && (t.render(t._lazy[0], t._lazy[1], true)._lazy = 0)
    },
    Ce = function (e, t, n, i) {
      ;(re.length && ye(),
    ...
    Ae = function (e, t, n, i, r) {
      ;(undefined === n && (n = "_first"), undefined === i && (i = "_last"))
      var o,
        a = e[i]
    ...
    Re = function (e, t, n, i) {
      return (
        ...
        (a
          ...
          : (e.vars.immediateRender && !e.vars.autoRevert) || e._startAt.render(t, true, i))
      )
    },
    ke = function e(t) {
    ...
    Ge = function (e, t) {
      ...
      if (
        ((t._time || (t._initted && !t._dur)) &&
          ((n = Be(e.rawTime(), t)),
          (!t._dur || Je(0, t.totalDuration(), n) - t._tTime > x) && t.render(n, true)),
      ...
      return (
        ...
        e._initted
          ? !n &&
            e._pt &&
            !a &&
            ((e._dur && false !== e.vars.lazy) || (!e._dur && e.vars.lazy)) &&
            p !== Rt.frame
    ...
    qe = function e(t, n, i) {
      var r,
        ...
        s = t.labels,
        u = t._recent || Xe,
        l = t.duration() >= w ? u.endTime(false) : t._dur
    ...
    ct = function (e, t, n, i) {
      return $e(U(e) ? !t : true === n ? !!(n = 0) : !i, function () {
        return U(e)
    ...
    yt = function e(t, n, i, r) {
      ...
      if (!o) {
        var a,
          ...
          d = M(t),
          h = {}
        if ((true === i && (r = 1) && (i = null), d)) ((t = { p: t }), (n = { p: n }))
        else if (U(t) && !U(n)) {
    ...
    Ot = function (e) {
      ...
      if (((Mt.lastIndex = 0), Mt.test(n)))
        return ((t = Pt.test(n)), (e[1] = It(e[1], t)), (e[0] = It(e[0], t, At(e[1]))), true)
    },
    Rt = (function () {
      var e,
        t,
      ...
      return (
        ...
        (t.timeScale = function (e) {
          ...
          return (
            ...
            this.totalTime(Je(-this._delay, this._tDur, t), true),
            Fe(this),
            Oe(this)
          )
        }),
        ...
        (t.revert = function (e) {
          ...
          return (
            ...
            "nested" !== this.data && false !== e.kill && this.kill(),
            (a = t),
            this
          )
        }),
        ...
        (t.reverse = function (e, t) {
          return (
            ...
            this.reversed(true).paused(false)
          )
        }),
    ...
    return (
      ...
      (n.render = function (e, t, n) {
        ...
        if ((this !== u && C > v && e >= 0 && (C = v), C !== this._tTime || n || b)) {
          ...
          ;(this._onUpdate && !t && bt(this, "onUpdate", true),
            ((C === v && this._tTime >= this.totalDuration()) || (!C && m)) &&
              ((p !== this._start && Math.abs(h) === Math.abs(this._ts)) ||
                ...
                t ||
                  (e < 0 && !m) ||
                  (!C && !m && v) ||
                  (bt(this, C === v && e >= 0 ? "onComplete" : "onReverseComplete", true),
      ...
      (n.getChildren = function (e, t, n, i) {
        ...
        for (var r = [], o = this._first; o; )
          (o._start >= i &&
            (o instanceof an
              ? t && r.push(o)
              : (n && r.push(o), e && r.push.apply(r, o.getChildren(true, t, n)))),
            (o = o._next))
        return r
      }),
                ...
                onStart: function () {
                  if ((i.pause(), !n)) {
                    var e =
                      t.duration ||
                      Math.abs((r - (a && "time" in a ? a.time : i._time)) / i.timeScale())
                    ;(c._dur !== e && Ye(c, e, 0, 1).render(c._time, true, true), (n = 1))
                  }
                  s && s.apply(c, u || [])
                },
              },
      ...
      (n.nextLabel = function (e) {
        return (undefined === e && (e = this._time), Ct(this, qe(this, e)))
      }),
      (n.previousLabel = function (e) {
        return (undefined === e && (e = this._time), Ct(this, qe(this, e), 1))
      }),
      (n.currentLabel = function (e) {
        return arguments.length ? this.seek(e, true) : this.previousLabel(this._time + x)
      }),
          ...
          for (i = o.parent; a; )
            ((t = a._prev),
              ...
              n < 0 &&
                ...
                o.shiftChildren(-n, false, -Infinity),
                (s = 0)),
  ...
  var qt,
    ...
    en = function e(t, n, i) {
      ...
      if (
        (H && (!R || !T) && (T = "none"),
        (t._ease = jt(T, b.ease)),
        (t._yEase = O ? Ut(jt(true === O ? T : O, b.ease)) : 0),
        ...
        if (
          ...
          B &&
            ...
            n < 0 && P && L && !k ? B.render(-1, true) : B.revert(P && D ? te : ee),
            (B._lazy = 0)),
          S)
        ) {
          if (
          ...
          if (
            ...
            (t._startAt._dp = 0),
            n < 0 && (a ? t._startAt.revert(te) : t._startAt.render(-1, true)),
            (t._zTime = n),
            L)
          ) {
            if (!n) return
        ...
        for (t._pt = t._ptCache = 0, E = (D && N(E)) || (E && !D), s = 0; s < F.length; s++) {
          if (
            ...
            (m = G === F ? s : G.indexOf(d)),
            f &&
              false !== (_ = new f()).init(d, v || r, t, m, G) &&
  ...
  var an = (function (e) {
    function t(t, n, r, a) {
      ...
      return (
        true !== x || o || ((qt = i(s)), u.killTweensOf(I), (qt = 0)),
        je(A, i(s), r),
        n.reversed && s.reverse(),
        n.paused && s.paused(true),
    ...
    return (
        ...
        if (_) {
          if (
            ...
            if (((i = m), (d = this.timeline), this._repeat)) {
              ...
              o !== u &&
                ...
                !this.vars.repeatRefresh ||
                  l ||
                  this._lock ||
                  ((this._lock = n = 1), (this.render(ge(s * o), true).invalidate()._lock = 0)))
            }
            if (!this._initted) {
            ...
            ;((d &&
              ...
              (m !== this._tDur && m) ||
                this._tTime !== m ||
                (g && !this._onUpdate && Re(this, e, 0, true),
                (e || !_) &&
                ...
                t ||
                  (g && !p) ||
                  !(m || p || l) ||
                  (bt(this, m === f ? "onComplete" : "onReverseComplete", true),
            ...
            if (
              ...
              ;(t < 0 && Re(e, t, 0, true),
                ...
                (t >= e._tDur || t < 0) &&
                  ...
                  n ||
                    a ||
                    (bt(e, l ? "onComplete" : "onReverseComplete", true), e._prom && e._prom())))
      ...
      (n.kill = function (e, t) {
        if ((undefined === t && (t = "all"), !(e || (t && "all" !== t))))
          return ((this._lazy = this._pt = 0), this.parent ? wt(this) : this)
        if (this.timeline) {
          var n = this.timeline.totalDuration()
          return (
            this.timeline.killTweensOf(e, t, qt && true !== qt.vars.overwrite)._first || wt(this),
            this.parent &&
        ...
        for (
          ...
          if (~d.indexOf(c[l]))
            ...
            a))
              ((u = r && r[s]) &&
                (("kill" in u.d && true !== u.d.kill(s)) || Ie(this, u, "_pt"), delete r[s]),
                "all" !== o && (o[s] = 1))
  ...
  var bn = [],
        ...
        (t.kill = function (e, t) {
          ...
          if (e) {
            ...
            ;(this.data.forEach(function (e) {
              "isFlip" === e.data &&
                (e.revert(),
                e.getChildren(true, true, false).forEach(function (e) {
    ...
    In = {
      ...
      quickTo: function (e, t, n) {
        var i,
          r = On.to(e, Te((((i = {})[t] = "+=0.1"), (i.paused = true), i), n || {})),
          o = function (e, n, i) {
      ...
      isTweening: function (e) {
        return u.getTweensOf(e, true).length > 0
      },
      defaults: function (e) {
